...
INSERT INTO `hibernate_sequence` VALUES (548);
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `Ticket_Price_Up` BEFORE INSERT ON `ticket` FOR EACH ROW SET NEW.price = NEW.price + NEW.price * 
 (SELECT seat_class.price FROM seat_class WHERE seat_class.id_seat_class = NEW.seat_class_id) / 100 */;;
DELIMITER ;
...
-- Dump completed on 2022-12-12 17:31:29
